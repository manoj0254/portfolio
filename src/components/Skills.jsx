...
import GitHub from '../assets/skill-logos/github.png'; 
    ...
    <div className='container mx-auto px-4'>
        <header data-aos='fade-up' data-aos-delay='500' className='text-center mb-16'>
            <h2 id='skills-heading' className='text-3xl md:text-4xl font-bold text-white mb-4'>
                My <span className='text-indigo-600'>Skills-set</span>
            </h2>
            <p className='text-lg text-gray-100 max-w-2xl mx-auto'>
                Please Go go through my skills-set
            </p>
        </header>
        <ul data-aos='fade-up' data-aos-delay='500'
        className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10 gap-8 aos-init aos-animate'>
                {skills.map((skill, index) => (
                   <li key={index} data-aos-delay='500' className='aos-animate'>
                        <article className='bg-white rounded-xl xl:p-8 hover:shadow-lg transition-all duration-300  hover:translate-y-[-5px] h-full flex flex-col'>
